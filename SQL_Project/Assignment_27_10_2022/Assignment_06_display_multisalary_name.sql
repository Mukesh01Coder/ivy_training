CREATE TABLE employee1(emp_id INT,emp_name varchar(20) NOT NULL UNIQUE,salary BIGINT)
...
WHERE salary
IN ( SELECT salary FROM employee1 GROUP BY salary HAVING COUNT(salary) > 1)
